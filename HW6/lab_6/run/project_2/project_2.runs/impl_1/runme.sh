...
HD_PWD='/home/will/DSP/HW6/lab_6/run/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_top.tcl -notrace
