...
HD_PWD='/nethome/wsutton8/ECE6276/ECE6276/HW3/lab_3/run/vivado_run/project_1_unoptimized/project_1_unoptimized.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mac.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mac.tcl
