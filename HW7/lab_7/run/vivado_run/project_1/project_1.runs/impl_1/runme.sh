...
HD_PWD='/home/will/DSP/HW7/lab_7/run/vivado_run/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_v2_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processor_v2_top.tcl -notrace
