...
HD_PWD='/home/will/DSP/HW7/lab_7/run/vivado_run/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_v2_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processor_v2_top.tcl
