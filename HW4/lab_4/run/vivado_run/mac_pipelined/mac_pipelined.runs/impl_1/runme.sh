...
HD_PWD='/nethome/wsutton8/ECE6276/ECE6276/HW4/lab_4/run/vivado_run/mac_pipelined/mac_pipelined.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source processor_top.tcl -notrace
