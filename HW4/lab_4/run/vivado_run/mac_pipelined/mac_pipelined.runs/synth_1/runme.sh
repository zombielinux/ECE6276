...
HD_PWD='/nethome/wsutton8/ECE6276/ECE6276/HW4/lab_4/run/vivado_run/mac_pipelined/mac_pipelined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source processor_top.tcl
