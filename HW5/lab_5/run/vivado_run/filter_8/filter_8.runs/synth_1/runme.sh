...
HD_PWD='/home/will/DSP/HW5/lab_5/run/vivado_run/filter_8/filter_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log filter_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source filter_8.tcl
