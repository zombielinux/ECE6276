...
HD_PWD='/nethome/wsutton8/ECE6276/ECE6276/HW2/lab_2/vivado_run/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log barrel_shifter.vdi -applog -m64 -messageDb vivado.pb -mode batch -source barrel_shifter.tcl -notrace
